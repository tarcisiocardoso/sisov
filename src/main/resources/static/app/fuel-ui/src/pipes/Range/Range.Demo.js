System.register(['angular2/core', "angular2/common", './Range', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, Range_1, CodeHighlighter_1;
    var RangeDemo, RANGE_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("RangeDemo", RangeDemo);
            exports_1("RANGE_DEMO_PROVIDERS", RANGE_DEMO_PROVIDERS = [
                RangeDemo
            ]);
        }
    }
