System.register(['angular2/core', "angular2/common", './MapToIterable', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, MapToIterable_1, CodeHighlighter_1;
    var MapToIterableDemo, MAPTOITERABLE_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("MapToIterableDemo", MapToIterableDemo);
            exports_1("MAPTOITERABLE_DEMO_PROVIDERS", MAPTOITERABLE_DEMO_PROVIDERS = [
                MapToIterableDemo
            ]);
        }
    }
