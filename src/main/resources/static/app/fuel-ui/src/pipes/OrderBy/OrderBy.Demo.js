System.register(['angular2/core', "angular2/common", './OrderBy', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, OrderBy_1, CodeHighlighter_1;
    var Person, OrderByDemo, ORDERBY_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("OrderByDemo", OrderByDemo);
            exports_1("ORDERBY_DEMO_PROVIDERS", ORDERBY_DEMO_PROVIDERS = [
                OrderByDemo
            ]);
        }
    }
