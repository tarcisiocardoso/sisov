System.register(['angular2/core', './DateRangePicker', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, DateRangePicker_1, CodeHighlighter_1;
    var DateRangePickerDemo, DATERANGEPICKER_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("DateRangePickerDemo", DateRangePickerDemo);
            exports_1("DATERANGEPICKER_DEMO_PROVIDERS", DATERANGEPICKER_DEMO_PROVIDERS = [
                DateRangePickerDemo
            ]);
        }
    }
