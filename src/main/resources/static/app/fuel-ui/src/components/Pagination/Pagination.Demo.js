System.register(['angular2/core', './Pagination', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Pagination_1, CodeHighlighter_1;
    var PaginationDemo, PAGINATION_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("PaginationDemo", PaginationDemo);
            exports_1("PAGINATION_DEMO_PROVIDERS", PAGINATION_DEMO_PROVIDERS = [
                PaginationDemo
            ]);
        }
    }
