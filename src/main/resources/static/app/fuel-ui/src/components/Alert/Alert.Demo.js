System.register(['angular2/core', './Alert', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Alert_1, CodeHighlighter_1;
    var AlertDemo, ALERT_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("AlertDemo", AlertDemo);
            exports_1("ALERT_DEMO_PROVIDERS", ALERT_DEMO_PROVIDERS = [
                AlertDemo
            ]);
        }
    }
