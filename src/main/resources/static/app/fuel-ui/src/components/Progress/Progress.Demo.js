System.register(['angular2/core', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var ProgressDemo, PROGRESS_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("ProgressDemo", ProgressDemo);
            exports_1("PROGRESS_DEMO_PROVIDERS", PROGRESS_DEMO_PROVIDERS = [
                ProgressDemo
            ]);
        }
    }
