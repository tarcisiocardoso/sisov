System.register(['angular2/core', './DatePicker', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, DatePicker_1, CodeHighlighter_1;
    var DatePickerDemo, DATEPICKER_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("DatePickerDemo", DatePickerDemo);
            exports_1("DATEPICKER_DEMO_PROVIDERS", DATEPICKER_DEMO_PROVIDERS = [
                DatePickerDemo
            ]);
        }
    }
