System.register(['angular2/core', './Dropdown', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Dropdown_1, CodeHighlighter_1;
    var DropdownDemo, DROPDOWN_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("DropdownDemo", DropdownDemo);
            exports_1("DROPDOWN_DEMO_PROVIDERS", DROPDOWN_DEMO_PROVIDERS = [
                DropdownDemo
            ]);
        }
    }
