System.register(['angular2/core', './TableSortable', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, TableSortable_1, CodeHighlighter_1;
    var TableSortableDemo, TABLESORTABLE_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("TableSortableDemo", TableSortableDemo);
            exports_1("TABLESORTABLE_DEMO_PROVIDERS", TABLESORTABLE_DEMO_PROVIDERS = [
                TableSortableDemo
            ]);
        }
    }
