System.register(['angular2/core', './Collapse', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Collapse_1, CodeHighlighter_1;
    var CollapseDemo, COLLAPSE_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("CollapseDemo", CollapseDemo);
            exports_1("COLLAPSE_DEMO_PROVIDERS", COLLAPSE_DEMO_PROVIDERS = [
                CollapseDemo
            ]);
        }
    }
