System.register(['angular2/core', './Tooltip', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Tooltip_1, CodeHighlighter_1;
    var TooltipDemo, TOOLTIP_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("TOOLTIP_DEMO_PROVIDERS", TOOLTIP_DEMO_PROVIDERS = [
                TooltipDemo
            ]);
        }
    }
