System.register(['angular2/core', "angular2/common", './Animation', '../../directives/CodeHighlighter/CodeHighlighter'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, Animation_1, CodeHighlighter_1;
    var AnimationDemo, ANIMATION_DEMO_PROVIDERS;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            exports_1("AnimationDemo", AnimationDemo);
            exports_1("ANIMATION_DEMO_PROVIDERS", ANIMATION_DEMO_PROVIDERS = [
                AnimationDemo
            ]);
        }
    }
